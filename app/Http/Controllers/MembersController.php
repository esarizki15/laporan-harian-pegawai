...
class MembersController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function atasan(StoreMemberRequest $request){
    ...
    Session::flash("flash_notification", [
            "level"=>"success",
            "message"=>"Berhasil menyimpan $atasan->name"
        ]);
    return redirect()->route('members.index');

    }
    public function admin(StoreMemberRequest $request){
    ...
    {
        $this->validate($request, ['name' => 'required|unique:users,name,'. $id]);
        $author = User::find($id);
